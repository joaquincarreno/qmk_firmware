...
#define dCOPY  LCTL(KC_C)
#define dPASTE LCTL(KC_V)
#define dUNDO  LCTL(KC_Z)

#define qCOPY  LCTL(KC_I)
#define qPASTE LCTL(KC_DOT)
#define qUNDO  LCTL(KC_SLASH)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT_reviung41(
    KC_ESC,   KC_Q,     KC_W,     KC_E,     KC_R,      KC_T,               KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,     KC_BSPC,
      STAB,   KC_A,     KC_S,     KC_D,     KC_F,      KC_G,               KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,
  ...
  [_DVORAK] = LAYOUT_reviung41(
    KC_ESC,  KC_QUOT,  KC_COMM,  KC_DOT,     KC_P,      KC_Y,               KC_F,     KC_G,     KC_C,     KC_R,     KC_L,     KC_BSPC,
      STAB,     KC_A,     KC_O,    KC_E,     KC_U,      KC_I,               KC_D,     KC_H,     KC_T,     KC_N,     KC_S,     KC_MINS,
  ...
  [_LOWER2] = LAYOUT_reviung41(
    KC_ESC,   KC_EXLM,  KC_AT,    KC_HASH,  KC_DLR,    KC_PERC,            KC_CIRC,  KC_AMPR,  KC_ASTR,  KC_LPRN,  KC_RPRN,  KC_DEL,
    _______,  KC_LCBR,  KC_RCBR,  KC_QUES,  KC_PLUS,   KC_PIPE,            KC_GRV,   KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT,  KC_TILD,
    _______,    dUNDO,    dCOPY,   dPASTE,  KC_CAPS,   KC_UNDS,            KC_HOME,  KC_END,   KC_PGUP,  KC_PGDN,  KC_PSCR,  RSFT_T(KC_SPC),
                                            _______,   _______,  KC_ENT,   _______,  _______
  ),
  ...
  [_RAISE2] = LAYOUT_reviung41(
    KC_ESC,   KC_1,     KC_2,     KC_3,     KC_4,      KC_5,               KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_DEL,
    KC_VOLU,  KC_LBRC,  KC_RBRC, KC_SLASH,   KC_EQL,   KC_BSLS,            KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,
    KC_VOLD,  KC_ESC,   KC_RGUI,  KC_RALT,  KC_CAPS,   KC_MINS,            KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,
                                            _______,   _______,  KC_BSPC,  _______,  _______
  ),
